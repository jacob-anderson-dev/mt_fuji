...
const PLAYER_IDLE_FRAMES: [Rect; 10] = [
    Rect { x: (0.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (1.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (2.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (3.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (4.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (5.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (6.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (7.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (8.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
    Rect { x: (9.0 * (31.0 + 17.0) + 14.0),  y: 11.0, w: 17.0, h: 32.0 },
];
